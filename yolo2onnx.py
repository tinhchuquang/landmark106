...
parser.add_argument('--onnx_model', default="./checkpoints/yolo/yolo_regression.onnx")
parser.add_argument('--onnx_model_sim',
                    help='Output ONNX model',
                    default="./checkpoints/yolo/yolo_regression_sim.onnx")
...
yolo_backbone = YOLOv10_Landmark_Flatten(num_landmarks=98)
